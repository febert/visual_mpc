...
'pretrained_model':base_dir + '/tensorflow_data/sim/pos_ctrl_updown_sact_ctxt1/modeldata/model160002',     # 'filepath of a pretrained model to resume training from.' ,
'sequence_length': 15,      # 'sequence length to load, including context frames.' ,
'skip_frame': 1,            # 'use ever i-th frame to increase prediction horizon' ,
'context_frames': 1,        # of frames before predictions.' ,
