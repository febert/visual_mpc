...
jsondir = base_dir + '/pretrained_models/sawyer_sim/ag_high_bowl'

configuration = {
'pred_model': Alex_Interface_Model,
'setup_predictor':setup_predictor,
'json_dir':jsondir,
'pretrained_model':jsondir + '/view0/model.savp.None/model-240000',     # 'filepath of a pretrained model to resume training from.' ,
