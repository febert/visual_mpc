...
'pretrained_model':base_dir + '/tensorflow_data/sim/onpolicy/updown_sact_onpolonly_iter1,2/modeldata/model196002',     # 'filepath of a pretrained model to resume training from.' ,
