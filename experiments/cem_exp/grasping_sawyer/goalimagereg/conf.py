...
modeldir = base_dir + '/pretrained_models/sawyer_reopen'
configuration = {
'pred_model': Alex_Interface_Model,
'setup_predictor':setup_predictor,
'json_dir':  modeldir,
'pretrained_model': modeldir + '/model.multi_savp.None/model-150000',   # 'filepath of a pretrained model to resume training from.' ,
