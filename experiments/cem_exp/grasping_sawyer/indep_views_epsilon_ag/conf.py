...
modeldir = base_dir + '/pretrained_models/sawyer_robot/gripper_env/'
configuration = {
...
'pretrained_model':[modeldir + '/view0/model.savp.None/model-170000', modeldir + '/view1/model.savp.None/model-300000'],   # 'filepath of a pretrained model to resume training from.' ,
