...
from video_prediction.nonrec_enc.prediction_train_nonrec import Model
...
'pretrained_model': LSDC_BASE +'/tensorflow_data/nonrec/test1/modeldata/model48002',     # 'filepath of a pretrained model to resume training from.' ,
