...
'pretrained_model': BASE_DIR + '/tensorflow_data/rewardnet/batchnorm_nomovingaverage/modeldata/model48002',     # 'filepath of a pretrained model to resume training from.' ,
