...
'pretrained_model': BASE_DIR + '/tensorflow_data/rewardnet/easygoal_25step/modeldata/model28002',     # 'filepath of a pretrained model to resume training from.' ,
'sequence_length': 25,      # 'sequence length, including context frames.' ,
'train_val_split': 0.95,    #'The percentage of files to use for the training set vs. the validation set.' ,
'batch_size': 204,           #'batch size for training' ,
