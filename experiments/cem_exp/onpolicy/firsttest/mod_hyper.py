...
onpolconf = {
    'infnet_reload_freq':1,     # reload inference model weights after n number of new trajectores collected
    'replay_size':10,
    'prefil_replay':1000,        # fill replay with existing trajectories from dataset
}
