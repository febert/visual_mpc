...
from python_visual_mpc.visual_mpc_core.algorithm.cem_controller_vidpred_variants.image_difference_policy import Image_Difference_Policy
import datetime

ctimestr = 'baseline-' + datetime.datetime.now().strftime("%Y-%m-%d:%H:%M:%S")
