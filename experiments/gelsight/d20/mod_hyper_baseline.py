...
from python_visual_mpc.visual_mpc_core.algorithm.cem_controller_vidpred_variants.dice_image_difference_policy import Dice_Image_Difference_Policy
import datetime
...
agent = {
    ...
    'adim': 3,
    'sdim': 3,
    'start_goal_confs': VMPC_BASE_DIR + '/experiments/gelsight/dice/adjacent_face_goals',
...
policy = {
    'type': Dice_Image_Difference_Policy,
