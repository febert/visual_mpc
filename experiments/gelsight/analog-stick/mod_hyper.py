...
BASE_DIR = '/'.join(str.split(__file__, '/')[:-1]) + '/joystick_exp_data'
...
agent = {
    ...
    'adim': 3,
    'sdim': 3,
    'start_goal_confs': VMPC_BASE_DIR + '/experiments/gelsight/joystick/bench_goal_images_reshaped',
