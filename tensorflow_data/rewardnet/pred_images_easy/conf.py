...
DATA_DIR = '/'.join(str.split(current_dir, '/')[:-3]) + '/experiments/cem_exp/benchmarks_goalimage/pixelerror_store_pred_easy/tfrecords/train'
...
'sequence_length': 23,      # 'sequence length, including context frames.' ,
