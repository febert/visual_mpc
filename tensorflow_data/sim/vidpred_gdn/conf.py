...
from python_visual_mpc.video_prediction.dynamic_rnn_model.vidpred_gdn import VidPred_GDN_Model

configuration = {
'experiment_name': 'rndaction_var10',
'pred_model':VidPred_GDN_Model,
...
'sawyer':'',
'single_view':"",
'use_len':15,                # number of steps used for training where the starting location is selected randomly within sequencelength
'1stimg_bckgd':'',
'visual_flowvec':'',
'adim':3,
'sdim':6,
...
'gen_img':'',
'orig_size':[48,64],
'vidpred_data':''             # train gdn to use gen_images
}