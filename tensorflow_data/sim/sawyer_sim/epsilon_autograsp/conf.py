...
DATA_DIR = {os.environ['VMPC_DATA_DIR'] + '/sawyer_sim/autograsp_epsilon_policy_newphysics_1/good': 8,
            os.environ['VMPC_DATA_DIR'] + '/sawyer_sim/autograsp_epsilon_policy_newphysics_1/bad': 8,
            }
