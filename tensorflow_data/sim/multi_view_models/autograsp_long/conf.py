...
DATA_DIR = {os.environ['VMPC_DATA_DIR'] + '/cartgripper/grasping/ag_scripted_longtraj/good' : 0.5,
            os.environ['VMPC_DATA_DIR'] + '/cartgripper/grasping/ag_scripted_longtraj/bad' : 0.5}
