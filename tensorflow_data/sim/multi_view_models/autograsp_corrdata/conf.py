...
DATA_DIR = {os.environ['VMPC_DATA_DIR'] + '/cartgripper/grasping/dctouch_scripted_autograsp_randinit/good' : 0.5,
            os.environ['VMPC_DATA_DIR'] + '/cartgripper/grasping/dctouch_scripted_autograsp_randinit/bad' : 0.5}
