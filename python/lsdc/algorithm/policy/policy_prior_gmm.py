...
from lsdc.algorithm.policy.config import POLICY_PRIOR_GMM
from lsdc.utility.gmm import GMM
from lsdc.algorithm.algorithm_utils import gauss_fit_joint_prior
...
class PolicyPriorGMM(object):
    ...
    python/lsdc/algorithm.algorithm_badmm.py.

    Also see the GMM dynamics prior, in
    python/lsdc/algorithm/dynamics/dynamics_prior_gmm.py. This is a
