...
_SAMPLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_DATA_TYPES', index=17, number=17,
      options=None,
      type=None),
  ],
...
_POSITIONCONTROLMODE = _descriptor.EnumDescriptor(
  ...
  full_name='lsdc.PositionControlMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SAMPLE = _descriptor.Descriptor(
  name='Sample',
  full_name='lsdc.Sample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='T', full_name='lsdc.Sample.T', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dX', full_name='lsdc.Sample.dX', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dU', full_name='lsdc.Sample.dU', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dO', full_name='lsdc.Sample.dO', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='X', full_name='lsdc.Sample.X', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='U', full_name='lsdc.Sample.U', index=5,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='obs', full_name='lsdc.Sample.obs', index=6,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    _descriptor.FieldDescriptor(
      name='meta', full_name='lsdc.Sample.meta', index=7,
...
class Sample(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:lsdc.Sample)


_SAMPLE.fields_by_name['X'].has_options = True
_SAMPLE.fields_by_name['X']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_SAMPLE.fields_by_name['U'].has_options = True
_SAMPLE.fields_by_name['U']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_SAMPLE.fields_by_name['obs'].has_options = True
_SAMPLE.fields_by_name['obs']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_SAMPLE.fields_by_name['meta'].has_options = True
_SAMPLE.fields_by_name['meta']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
