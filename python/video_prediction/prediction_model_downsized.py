...
def construct_model(images,
    ...
    """
    print 'constructing downsized network...'
    ...
    for image, action in zip(images[:-1], actions[:-1]):
        ...
        with slim.arg_scope(
            ...
            if stp:
                ...
                transformed += stp_transformation(prev_image, stp_input1, num_masks, reuse_sc=reuse)
...
## Utility functions
def stp_transformation(prev_image, stp_input, num_masks, reuse_sc = None):
    ...
    for i in range(num_masks - 1):
        params = slim.layers.fully_connected(
            ...
            activation_fn=None, reuse= reuse_sc) + identity_params
