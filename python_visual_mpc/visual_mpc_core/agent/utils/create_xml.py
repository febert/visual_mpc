...
def create_object_xml(hyperparams, load_dict_list=None):
    ...
    for i in range(hyperparams['num_objects']):
        ...
        ET.SubElement(obj, "geom", type="box", size=".03 {} .03".format(l1), rgba="{} {} {} 1".format(color1[0], color1[1], color1[2]), density="25", friction="2 0.010 0.0002")


        ET.SubElement(obj, "geom", pos="{} {} 0.0".format(l2, pos2), type="box", size="{} .03 .03".format(l2),
                      rgba="{} {} {} 1".format(color2[0], color2[1], color2[2]), density="25", friction="2 0.010 0.0002")
