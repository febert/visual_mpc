...
if __name__ == '__main__':
    ...
    dir = '/mnt/sda1/experiments/cem_exp/benchmarks/pos_ctrl/reg_startgoal_threshterm'
    conf_dir = '/mnt/sda1/visual_mpc/experiments/cem_exp/benchmarks/pos_ctrl/reg_startgoal_threshterm'
