...
from lsdc.agent.config import AGENT, AGENT_BOX2D, AGENT_ROS, AGENT_MUJOCO
from lsdc.algorithm.config import ALG, ALG_BADMM
from lsdc.algorithm.traj_opt.config import TRAJ_OPT_LQR
from lsdc.algorithm.policy.config import INIT_LG_LQR, INIT_LG_PD, POLICY_PRIOR, POLICY_PRIOR_GMM
from lsdc.algorithm.cost.config import COST_FK, COST_STATE, COST_SUM, COST_ACTION
from lsdc.algorithm.dynamics.config import DYN_PRIOR_GMM
from lsdc.algorithm.policy_opt.config import POLICY_OPT_CAFFE
