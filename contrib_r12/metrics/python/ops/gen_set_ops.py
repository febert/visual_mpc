...
_DenseToDenseSetOperationOutput = collections.namedtuple("DenseToDenseSetOperation",
                                                         _dense_to_dense_set_operation_outputs)


def dense_to_dense_set_operation(set1, set2, set_operation,
...
_DenseToSparseSetOperationOutput = collections.namedtuple("DenseToSparseSetOperation",
                                                          _dense_to_sparse_set_operation_outputs)


def dense_to_sparse_set_operation(set1, set2_indices, set2_values, set2_shape,
...
_set_size_outputs = ["size"]


def set_size(set_indices, set_values, set_shape, validate_indices=None,
             name=None):
...
_SparseToSparseSetOperationOutput = collections.namedtuple("SparseToSparseSetOperation",
                                                           _sparse_to_sparse_set_operation_outputs)


def sparse_to_sparse_set_operation(set1_indices, set1_values, set1_shape,
