...
def create_instance(proj_id, instance_num, exp_name, nworkers, nsplit):
    gcloud_command = default_command.format(proj_id, instance_num, nworkers, nsplit, instance_num, exp_name)
    print('requesting instance: {}'.format(instance_num))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nworkers', type=int, help='number of worker proccesses per instance', default=1)
